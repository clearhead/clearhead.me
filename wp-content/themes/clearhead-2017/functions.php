<?php
/**
 * clearhead-2017 functions and definitions.
 *
...
if ( ! function_exists( 'clearhead_2017_setup' ) ) :
/**
 ...
 */
function clearhead_2017_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on clearhead-2017, use a find and replace
	 * to change 'clearhead-2017' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'clearhead-2017', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'clearhead-2017' ),
		'footer' => esc_html__( 'Footer Menu', 'clearhead-2017' ),
		'featured-posts' => esc_html__( 'Featured Posts', 'clearhead-2017' ),
		'featured-categories' => esc_html__( 'Featured Categories', 'clearhead-2017' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'clearhead_2017_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'clearhead_2017_setup' );
 ...
 */
function clearhead_2017_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'clearhead_2017_content_width', 800 );
}
add_action( 'after_setup_theme', 'clearhead_2017_content_width', 0 );
 ...
 */
function clearhead_2017_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'clearhead-2017' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'clearhead-2017' ),
...
add_action( 'widgets_init', 'clearhead_2017_widgets_init' );
 ...
 */
function clearhead_2017_scripts_and_styles() {
	if(is_front_page() || is_page_template( 'templates/service.php' )) {
	...
	wp_enqueue_script( 'bowser', get_template_directory_uri() . '/js/bowser.js', array(), '20170722927', true );
	...
	wp_enqueue_script( 'clearhead-2017-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'clearhead_2017_scripts_and_styles' );
