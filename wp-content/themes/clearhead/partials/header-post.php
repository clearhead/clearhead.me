...
<div class="entry-header py3"<?php if ($hero) { echo "style='background-image:url(".$hero.")'";} ?>>
	<div class="container">
	...
	<div class="social sm-show sm-col sm-col-4 md-col-3 right-align low">
		...
		<a href="http://www.facebook.com/sharer.php?u=<?php the_permalink(); ?>">
			<svg width="20" height="20" class="geomicon" data-icon="facebook" viewBox="0 0 32 32" style="fill:currentcolor"><path d="M8 12 L13 12 L13 8 C13 2 17 1 24 2 L24 7 C20 7 19 7 19 10 L19 12 L24 12 L23 18 L19 18 L19 30 L13 30 L13 18 L8 18 z "></path></svg>
		</a>
